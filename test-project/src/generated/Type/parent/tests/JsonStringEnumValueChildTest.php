 ...
 */
final class JsonStringEnumValueChildTest
{
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name>
	 */
	public $arrayOfEnumValues;

	/**
	 * @readonly
	 * @var list<list<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name>>
	 */
	public $arrayOfArraysOfEnumValues;

	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name|null>
	 */
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name|null>|null
	 */
	public $arrayOfEnumValuesAndNullsOrNull;

	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name>
	 */
	public $mapOfEnumValues;

	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name>>
	 */
	public $mapOfMapsOfEnumValues;

	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name|null>
	 */
	...
	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name|null>|null
	 */
	public $mapOfNullsAndEnumValuesOrNull;

	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name>>
	 */
	public $arrayOfMapsOfEnumValues;

	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name>>|null
	 */
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name|null>|null>|null
	 */
	public $arrayOfNullsAndMapsOfNullsAndEnumValuesOrNull;

	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<list<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name>>
	 */
	public $mapOfArraysOfEnumValues;

	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<list<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name>>|null
	 */
	...
	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<list<\JCG\Test\generated\Type\parent\tests\child\JsonStringEnum::Name|null>|null>|null
	 */
	...
	public function __construct($builder)
	{
		...
		if (is_null($builder_enumValue)) throw new \Exception('JsonStringEnumValueChildTest: enumValue must not be null.');
		if (is_null($builder_enumValueWithDescription)) throw new \Exception('JsonStringEnumValueChildTest: enumValueWithDescription must not be null.');
		if (is_null($builder_arrayOfEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: arrayOfEnumValues must not be null.');
		if (is_null($builder_arrayOfArraysOfEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: arrayOfArraysOfEnumValues must not be null.');
		if (is_null($builder_arrayOfEnumValuesAndNulls)) throw new \Exception('JsonStringEnumValueChildTest: arrayOfEnumValuesAndNulls must not be null.');
		if (is_null($builder_mapOfEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: mapOfEnumValues must not be null.');
		if (is_null($builder_mapOfMapsOfEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: mapOfMapsOfEnumValues must not be null.');
		if (is_null($builder_mapOfNullsAndEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: mapOfNullsAndEnumValues must not be null.');
		if (is_null($builder_arrayOfMapsOfEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: arrayOfMapsOfEnumValues must not be null.');
		if (is_null($builder_arrayOfNullsAndMapsOfEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: arrayOfNullsAndMapsOfEnumValues must not be null.');
		if (is_null($builder_arrayOfMapsOfNullsAndEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: arrayOfMapsOfNullsAndEnumValues must not be null.');
		if (is_null($builder_mapOfArraysOfEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: mapOfArraysOfEnumValues must not be null.');
		if (is_null($builder_mapOfNullsAndArraysOfEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: mapOfNullsAndArraysOfEnumValues must not be null.');
		if (is_null($builder_mapOfArraysOfNullsAndEnumValues)) throw new \Exception('JsonStringEnumValueChildTest: mapOfArraysOfNullsAndEnumValues must not be null.');
