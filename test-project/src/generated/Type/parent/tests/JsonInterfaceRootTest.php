 ...
 */
final class JsonInterfaceRootTest
{
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Type\JsonInterface>
	 */
	public $arrayOfObjects;

	/**
	 * @readonly
	 * @var list<list<\JCG\Test\generated\Type\JsonInterface>>
	 */
	...
	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\JsonInterface>
	 */
	public $mapOfObjects;

	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\JsonInterface>>
	 */
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\JsonInterface>>
	 */
	...
	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<list<\JCG\Test\generated\Type\JsonInterface>>
	 */
	...
	/**
	 * @param \JCG\Test\generated\Builder\parent\tests\JsonInterfaceRootTestBuilder<"OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK"> $builder
	 * @throws \Exception
	 */
	public function __construct($builder)
	{
		...
		if (is_null($builder_object_)) throw new \Exception('JsonInterfaceRootTest: object_ must not be null.');
		if (is_null($builder_objectWithDescription)) throw new \Exception('JsonInterfaceRootTest: objectWithDescription must not be null.');
		if (is_null($builder_arrayOfObjects)) throw new \Exception('JsonInterfaceRootTest: arrayOfObjects must not be null.');
		if (is_null($builder_arrayOfArraysOfObjects)) throw new \Exception('JsonInterfaceRootTest: arrayOfArraysOfObjects must not be null.');
		if (is_null($builder_arrayOfObjectsAndNulls)) throw new \Exception('JsonInterfaceRootTest: arrayOfObjectsAndNulls must not be null.');
		if (is_null($builder_mapOfObjects)) throw new \Exception('JsonInterfaceRootTest: mapOfObjects must not be null.');
		if (is_null($builder_mapOfMapsOfObjects)) throw new \Exception('JsonInterfaceRootTest: mapOfMapsOfObjects must not be null.');
		if (is_null($builder_mapOfNullsAndObjects)) throw new \Exception('JsonInterfaceRootTest: mapOfNullsAndObjects must not be null.');
		if (is_null($builder_arrayOfMapsOfObjects)) throw new \Exception('JsonInterfaceRootTest: arrayOfMapsOfObjects must not be null.');
		if (is_null($builder_arrayOfNullsAndMapsOfObjects)) throw new \Exception('JsonInterfaceRootTest: arrayOfNullsAndMapsOfObjects must not be null.');
		if (is_null($builder_arrayOfMapsOfNullsAndObjects)) throw new \Exception('JsonInterfaceRootTest: arrayOfMapsOfNullsAndObjects must not be null.');
		if (is_null($builder_mapOfArraysOfObjects)) throw new \Exception('JsonInterfaceRootTest: mapOfArraysOfObjects must not be null.');
		if (is_null($builder_mapOfNullsAndArraysOfObjects)) throw new \Exception('JsonInterfaceRootTest: mapOfNullsAndArraysOfObjects must not be null.');
		if (is_null($builder_mapOfArraysOfNullsAndObjects)) throw new \Exception('JsonInterfaceRootTest: mapOfArraysOfNullsAndObjects must not be null.');
