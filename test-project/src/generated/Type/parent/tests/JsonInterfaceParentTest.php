 ...
 */
final class JsonInterfaceParentTest
{
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Type\parent\JsonInterface>
	 */
	public $arrayOfObjects;

	/**
	 * @readonly
	 * @var list<list<\JCG\Test\generated\Type\parent\JsonInterface>>
	 */
	...
	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\JsonInterface>
	 */
	public $mapOfObjects;

	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\JsonInterface>>
	 */
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\JsonInterface>>
	 */
	...
	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<list<\JCG\Test\generated\Type\parent\JsonInterface>>
	 */
	...
	/**
	 * @param \JCG\Test\generated\Builder\parent\tests\JsonInterfaceParentTestBuilder<"OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK"> $builder
	 * @throws \Exception
	 */
	public function __construct($builder)
	{
		...
		if (is_null($builder_object_)) throw new \Exception('JsonInterfaceParentTest: object_ must not be null.');
		if (is_null($builder_objectWithDescription)) throw new \Exception('JsonInterfaceParentTest: objectWithDescription must not be null.');
		if (is_null($builder_arrayOfObjects)) throw new \Exception('JsonInterfaceParentTest: arrayOfObjects must not be null.');
		if (is_null($builder_arrayOfArraysOfObjects)) throw new \Exception('JsonInterfaceParentTest: arrayOfArraysOfObjects must not be null.');
		if (is_null($builder_arrayOfObjectsAndNulls)) throw new \Exception('JsonInterfaceParentTest: arrayOfObjectsAndNulls must not be null.');
		if (is_null($builder_mapOfObjects)) throw new \Exception('JsonInterfaceParentTest: mapOfObjects must not be null.');
		if (is_null($builder_mapOfMapsOfObjects)) throw new \Exception('JsonInterfaceParentTest: mapOfMapsOfObjects must not be null.');
		if (is_null($builder_mapOfNullsAndObjects)) throw new \Exception('JsonInterfaceParentTest: mapOfNullsAndObjects must not be null.');
		if (is_null($builder_arrayOfMapsOfObjects)) throw new \Exception('JsonInterfaceParentTest: arrayOfMapsOfObjects must not be null.');
		if (is_null($builder_arrayOfNullsAndMapsOfObjects)) throw new \Exception('JsonInterfaceParentTest: arrayOfNullsAndMapsOfObjects must not be null.');
		if (is_null($builder_arrayOfMapsOfNullsAndObjects)) throw new \Exception('JsonInterfaceParentTest: arrayOfMapsOfNullsAndObjects must not be null.');
		if (is_null($builder_mapOfArraysOfObjects)) throw new \Exception('JsonInterfaceParentTest: mapOfArraysOfObjects must not be null.');
		if (is_null($builder_mapOfNullsAndArraysOfObjects)) throw new \Exception('JsonInterfaceParentTest: mapOfNullsAndArraysOfObjects must not be null.');
		if (is_null($builder_mapOfArraysOfNullsAndObjects)) throw new \Exception('JsonInterfaceParentTest: mapOfArraysOfNullsAndObjects must not be null.');
