 ...
 */
final class JsonStringEnumValueLocalTest
{
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Type\parent\tests\JsonStringEnum::Name>
	 */
	public $arrayOfEnumValues;

	/**
	 * @readonly
	 * @var list<list<\JCG\Test\generated\Type\parent\tests\JsonStringEnum::Name>>
	 */
	...
	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\JsonStringEnum::Name>
	 */
	public $mapOfEnumValues;

	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\JsonStringEnum::Name>>
	 */
	...
	/**
	 * @readonly
	 * @var list<\JCG\Test\generated\Util\JsonMap<\JCG\Test\generated\Type\parent\tests\JsonStringEnum::Name>>
	 */
	...
	/**
	 * @readonly
	 * @var \JCG\Test\generated\Util\JsonMap<list<\JCG\Test\generated\Type\parent\tests\JsonStringEnum::Name>>
	 */
	...
	/**
	 * @param \JCG\Test\generated\Builder\parent\tests\JsonStringEnumValueLocalTestBuilder<"OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK", "OK"> $builder
	 * @throws \Exception
	 */
	public function __construct($builder)
	{
		...
		if (is_null($builder_enumValue)) throw new \Exception('JsonStringEnumValueLocalTest: enumValue must not be null.');
		if (is_null($builder_enumValueWithDescription)) throw new \Exception('JsonStringEnumValueLocalTest: enumValueWithDescription must not be null.');
		if (is_null($builder_arrayOfEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: arrayOfEnumValues must not be null.');
		if (is_null($builder_arrayOfArraysOfEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: arrayOfArraysOfEnumValues must not be null.');
		if (is_null($builder_arrayOfEnumValuesAndNulls)) throw new \Exception('JsonStringEnumValueLocalTest: arrayOfEnumValuesAndNulls must not be null.');
		if (is_null($builder_mapOfEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: mapOfEnumValues must not be null.');
		if (is_null($builder_mapOfMapsOfEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: mapOfMapsOfEnumValues must not be null.');
		if (is_null($builder_mapOfNullsAndEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: mapOfNullsAndEnumValues must not be null.');
		if (is_null($builder_arrayOfMapsOfEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: arrayOfMapsOfEnumValues must not be null.');
		if (is_null($builder_arrayOfNullsAndMapsOfEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: arrayOfNullsAndMapsOfEnumValues must not be null.');
		if (is_null($builder_arrayOfMapsOfNullsAndEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: arrayOfMapsOfNullsAndEnumValues must not be null.');
		if (is_null($builder_mapOfArraysOfEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: mapOfArraysOfEnumValues must not be null.');
		if (is_null($builder_mapOfNullsAndArraysOfEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: mapOfNullsAndArraysOfEnumValues must not be null.');
		if (is_null($builder_mapOfArraysOfNullsAndEnumValues)) throw new \Exception('JsonStringEnumValueLocalTest: mapOfArraysOfNullsAndEnumValues must not be null.');
