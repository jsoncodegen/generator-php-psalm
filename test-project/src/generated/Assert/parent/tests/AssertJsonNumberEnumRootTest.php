...
final class AssertJsonNumberEnumRootTest
{
	/**
	 * @param mixed $o
	 * @param ?bool $isNullable
	 * @param ?string $path
	 * @return \JCG\Test\generated\Type\parent\tests\JsonNumberEnumRootTest|null
	 * @throws \Exception
	 */
	public static function assert($o, $isNullable = false, $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumRootTest')
	{
		if (is_null($isNullable)) $isNullable = false;
		if (is_null($path)) $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumRootTest';
		if (is_null($o)) {
			if ($isNullable) {
				return null;
			} else {
				throw new \Exception("Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumRootTest, got null (at $path)");
			}
		}
		if (!is_object($o)) {
			$type = gettype($o);
			throw new \Exception(
				"Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumRootTest, got $type (at $path)"
			);
		}
		$o->enum_ = \JCG\Test\generated\Assert\AssertJsonNumberEnum::assert(
			$o->enum_,
			false,
			$path . '->enum_:\\JCG\\Test\\generated\\Type\\JsonNumberEnum'
		);
		$o->enumWithDescription = \JCG\Test\generated\Assert\AssertJsonNumberEnum::assert(
			$o->enumWithDescription,
			false,
			$path . '->enumWithDescription:\\JCG\\Test\\generated\\Type\\JsonNumberEnum'
		);
		$o->enumOrNull = \JCG\Test\generated\Assert\AssertJsonNumberEnum::assert(
			$o->enumOrNull,
			true,
			$path . '->enumOrNull:\\JCG\\Test\\generated\\Type\\JsonNumberEnum'
		);
		$o->arrayOfEnums = \JCG\Test\generated\Util\AssertUtil::assertArray(
			 ...
			 */
			function ($value, $path) {
				return \JCG\Test\generated\Assert\AssertJsonNumberEnum::assert(
					$value,
					false,
					$path
				);
		...
		/** @var \JCG\Test\generated\Type\parent\tests\JsonNumberEnumRootTest $result */
		$result = $o;
		return $result;
	}
}
