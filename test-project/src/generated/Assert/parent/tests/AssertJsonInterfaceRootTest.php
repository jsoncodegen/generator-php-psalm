...
final class AssertJsonInterfaceRootTest
{
	/**
	 * @param mixed $o
	 * @param ?bool $isNullable
	 * @param ?string $path
	 * @return \JCG\Test\generated\Type\parent\tests\JsonInterfaceRootTest|null
	 * @throws \Exception
	 */
	public static function assert($o, $isNullable = false, $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonInterfaceRootTest')
	{
		if (is_null($isNullable)) $isNullable = false;
		if (is_null($path)) $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonInterfaceRootTest';
		if (is_null($o)) {
			if ($isNullable) {
				return null;
			} else {
				throw new \Exception("Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonInterfaceRootTest, got null (at $path)");
			}
		}
		if (!is_object($o)) {
			$type = gettype($o);
			throw new \Exception(
				"Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonInterfaceRootTest, got $type (at $path)"
			);
		}
		$o->object_ = \JCG\Test\generated\Assert\AssertJsonInterface::assert(
			(isset($o->object_) ? $o->object_ : null),
			false,
			$path . '->object_'
		);
		$o->objectWithDescription = \JCG\Test\generated\Assert\AssertJsonInterface::assert(
			(isset($o->objectWithDescription) ? $o->objectWithDescription : null),
			false,
			$path . '->objectWithDescription'
		);
		$o->objectOrNull = \JCG\Test\generated\Assert\AssertJsonInterface::assert(
		...
		$o->arrayOfObjects = \JCG\Test\generated\Util\AssertUtil::assertArray(
			 ...
			 */
			function ($value, $path) {
				return \JCG\Test\generated\Assert\AssertJsonInterface::assert(
					$value,
					false,
					$path
				);
		...
		/** @var \JCG\Test\generated\Type\parent\tests\JsonInterfaceRootTest $result */
		$result = $o;
		return $result;
	}
}
