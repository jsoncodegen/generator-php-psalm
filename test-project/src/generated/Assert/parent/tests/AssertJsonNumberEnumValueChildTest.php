...
final class AssertJsonNumberEnumValueChildTest
{
	/**
	 * @param mixed $o
	 * @param ?bool $isNullable
	 * @param ?string $path
	 * @return \JCG\Test\generated\Type\parent\tests\JsonNumberEnumValueChildTest|null
	 * @throws \Exception
	 */
	public static function assert($o, $isNullable = false, $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumValueChildTest')
	{
		if (is_null($isNullable)) $isNullable = false;
		if (is_null($path)) $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumValueChildTest';
		if (is_null($o)) {
			if ($isNullable) {
				return null;
			} else {
				throw new \Exception("Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumValueChildTest, got null (at $path)");
			}
		}
		if (!is_object($o)) {
			$type = gettype($o);
			throw new \Exception(
				"Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumValueChildTest, got $type (at $path)"
			);
		}
		...
		$o->enumValue = \JCG\Test\generated\Util\AssertUtil::assertExactValue(
			...
			false,
			$path . '->enumValue:\\JCG\\Test\\generated\\Type\\parent\\tests\\child\\JsonNumberEnum:Name'
		);
		$o->enumValueWithDescription = \JCG\Test\generated\Util\AssertUtil::assertExactValue(
			...
			false,
			$path . '->enumValueWithDescription:\\JCG\\Test\\generated\\Type\\parent\\tests\\child\\JsonNumberEnum:Name'
		);
		$o->enumValueOrNull = \JCG\Test\generated\Util\AssertUtil::assertExactValue(
			\JCG\Test\generated\Type\parent\tests\child\JsonNumberEnum::Name,
			(isset($o->enumValueOrNull) ? $o->enumValueOrNull : null),
			true,
			$path . '->enumValueOrNull:\\JCG\\Test\\generated\\Type\\parent\\tests\\child\\JsonNumberEnum:Name'
		);
		...
		/** @var \JCG\Test\generated\Type\parent\tests\JsonNumberEnumValueChildTest $result */
		$result = $o;
		return $result;
	}
}
