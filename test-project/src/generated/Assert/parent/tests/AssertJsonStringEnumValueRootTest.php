...
final class AssertJsonStringEnumValueRootTest
{
	/**
	 * @param mixed $o
	 * @param ?bool $isNullable
	 * @param ?string $path
	 * @return \JCG\Test\generated\Type\parent\tests\JsonStringEnumValueRootTest|null
	 * @throws \Exception
	 */
	public static function assert($o, $isNullable = false, $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumValueRootTest')
	{
		if (is_null($isNullable)) $isNullable = false;
		if (is_null($path)) $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumValueRootTest';
		if (is_null($o)) {
			if ($isNullable) {
				return null;
			} else {
				throw new \Exception("Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumValueRootTest, got null (at $path)");
			}
		}
		if (!is_object($o)) {
			$type = gettype($o);
			throw new \Exception(
				"Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumValueRootTest, got $type (at $path)"
			);
		}
		$o->enumValue = \JCG\Test\generated\Util\AssertUtil::assertExactValue(
			...
			$o->enumValue,
			false,
			$path . '->enumValue:\\JCG\\Test\\generated\\Type\\JsonStringEnum:Name'
		);
		$o->enumValueWithDescription = \JCG\Test\generated\Util\AssertUtil::assertExactValue(
			\JCG\Test\generated\Type\JsonStringEnum::Name,
			$o->enumValueWithDescription,
			false,
			$path . '->enumValueWithDescription:\\JCG\\Test\\generated\\Type\\JsonStringEnum:Name'
		);
		$o->enumValueOrNull = \JCG\Test\generated\Util\AssertUtil::assertExactValue(
			\JCG\Test\generated\Type\JsonStringEnum::Name,
			$o->enumValueOrNull,
			true,
			$path . '->enumValueOrNull:\\JCG\\Test\\generated\\Type\\JsonStringEnum:Name'
		);
		...
		/** @var \JCG\Test\generated\Type\parent\tests\JsonStringEnumValueRootTest $result */
		$result = $o;
		return $result;
	}
}
