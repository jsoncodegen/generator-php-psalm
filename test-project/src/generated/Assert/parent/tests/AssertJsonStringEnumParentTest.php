...
final class AssertJsonStringEnumParentTest
{
	/**
	 * @param mixed $o
	 * @param ?bool $isNullable
	 * @param ?string $path
	 * @return \JCG\Test\generated\Type\parent\tests\JsonStringEnumParentTest|null
	 * @throws \Exception
	 */
	public static function assert($o, $isNullable = false, $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumParentTest')
	{
		if (is_null($isNullable)) $isNullable = false;
		if (is_null($path)) $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumParentTest';
		if (is_null($o)) {
			if ($isNullable) {
				return null;
			} else {
				throw new \Exception("Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumParentTest, got null (at $path)");
			}
		}
		if (!is_object($o)) {
			$type = gettype($o);
			throw new \Exception(
				"Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumParentTest, got $type (at $path)"
			);
		}
		$o->enum_ = \JCG\Test\generated\Assert\parent\AssertJsonStringEnum::assert(
			$o->enum_,
			false,
			$path . '->enum_:\\JCG\\Test\\generated\\Type\\parent\\JsonStringEnum'
		);
		$o->enumWithDescription = \JCG\Test\generated\Assert\parent\AssertJsonStringEnum::assert(
			$o->enumWithDescription,
			false,
			$path . '->enumWithDescription:\\JCG\\Test\\generated\\Type\\parent\\JsonStringEnum'
		);
		$o->enumOrNull = \JCG\Test\generated\Assert\parent\AssertJsonStringEnum::assert(
			$o->enumOrNull,
			true,
			$path . '->enumOrNull:\\JCG\\Test\\generated\\Type\\parent\\JsonStringEnum'
		);
		$o->arrayOfEnums = \JCG\Test\generated\Util\AssertUtil::assertArray(
			 ...
			 */
			function ($value, $path) {
				return \JCG\Test\generated\Assert\parent\AssertJsonStringEnum::assert(
					$value,
					false,
					$path
				);
		...
		/** @var \JCG\Test\generated\Type\parent\tests\JsonStringEnumParentTest $result */
		$result = $o;
		return $result;
	}
}
