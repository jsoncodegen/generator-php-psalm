...
final class AssertJsonNumberEnumLocalTest
{
	/**
	 * @param mixed $o
	 * @param ?bool $isNullable
	 * @param ?string $path
	 * @return \JCG\Test\generated\Type\parent\tests\JsonNumberEnumLocalTest|null
	 * @throws \Exception
	 */
	public static function assert($o, $isNullable = false, $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumLocalTest')
	{
		if (is_null($isNullable)) $isNullable = false;
		if (is_null($path)) $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumLocalTest';
		if (is_null($o)) {
			if ($isNullable) {
				return null;
			} else {
				throw new \Exception("Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumLocalTest, got null (at $path)");
			}
		}
		if (!is_object($o)) {
			$type = gettype($o);
			throw new \Exception(
				"Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumLocalTest, got $type (at $path)"
			);
		}
		$o->enum_ = \JCG\Test\generated\Assert\parent\tests\AssertJsonNumberEnum::assert(
			(isset($o->enum_) ? $o->enum_ : null),
			false,
			$path . '->enum_:\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnum'
		);
		$o->enumWithDescription = \JCG\Test\generated\Assert\parent\tests\AssertJsonNumberEnum::assert(
			(isset($o->enumWithDescription) ? $o->enumWithDescription : null),
			false,
			$path . '->enumWithDescription:\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnum'
		);
		$o->enumOrNull = \JCG\Test\generated\Assert\parent\tests\AssertJsonNumberEnum::assert(
			(isset($o->enumOrNull) ? $o->enumOrNull : null),
			true,
			$path . '->enumOrNull:\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnum'
		);
		$o->arrayOfEnums = \JCG\Test\generated\Util\AssertUtil::assertArray(
			 ...
			 */
			function ($value, $path) {
				return \JCG\Test\generated\Assert\parent\tests\AssertJsonNumberEnum::assert(
					$value,
					false,
					$path
				);
		...
		/** @var \JCG\Test\generated\Type\parent\tests\JsonNumberEnumLocalTest $result */
		$result = $o;
		return $result;
	}
}
