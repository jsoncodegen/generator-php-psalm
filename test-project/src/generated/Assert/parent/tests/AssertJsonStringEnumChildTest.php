...
final class AssertJsonStringEnumChildTest
{
	/**
	 * @param mixed $o
	 * @param ?bool $isNullable
	 * @param ?string $path
	 * @return \JCG\Test\generated\Type\parent\tests\JsonStringEnumChildTest|null
	 * @throws \Exception
	 */
	public static function assert($o, $isNullable = false, $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumChildTest')
	{
		if (is_null($isNullable)) $isNullable = false;
		if (is_null($path)) $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumChildTest';
		if (is_null($o)) {
			if ($isNullable) {
				return null;
			} else {
				throw new \Exception("Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumChildTest, got null (at $path)");
			}
		}
		if (!is_object($o)) {
			$type = gettype($o);
			throw new \Exception(
				"Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonStringEnumChildTest, got $type (at $path)"
			);
		}
		...
		$o->arrayOfEnums = \JCG\Test\generated\Util\AssertUtil::assertArray(
			 ...
			 */
			function ($value, $path) {
				return \JCG\Test\generated\Assert\parent\tests\child\AssertJsonStringEnum::assert(
					$value,
					false,
					$path
				);
		...
		/** @var \JCG\Test\generated\Type\parent\tests\JsonStringEnumChildTest $result */
		$result = $o;
		return $result;
	}
}
