...
final class AssertJsonNumberEnumSiblingTest
{
	/**
	 * @param mixed $o
	 * @param ?bool $isNullable
	 * @param ?string $path
	 * @return \JCG\Test\generated\Type\parent\tests\JsonNumberEnumSiblingTest|null
	 * @throws \Exception
	 */
	public static function assert($o, $isNullable = false, $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumSiblingTest')
	{
		if (is_null($isNullable)) $isNullable = false;
		if (is_null($path)) $path = '\\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumSiblingTest';
		if (is_null($o)) {
			if ($isNullable) {
				return null;
			} else {
				throw new \Exception("Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumSiblingTest, got null (at $path)");
			}
		}
		if (!is_object($o)) {
			$type = gettype($o);
			throw new \Exception(
				"Expected \\JCG\\Test\\generated\\Type\\parent\\tests\\JsonNumberEnumSiblingTest, got $type (at $path)"
			);
		}
		$o->enum_ = \JCG\Test\generated\Assert\parent\sibling\AssertJsonNumberEnum::assert(
			$o->enum_,
			false,
			$path . '->enum_:\\JCG\\Test\\generated\\Type\\parent\\sibling\\JsonNumberEnum'
		);
		$o->enumWithDescription = \JCG\Test\generated\Assert\parent\sibling\AssertJsonNumberEnum::assert(
			$o->enumWithDescription,
			false,
			$path . '->enumWithDescription:\\JCG\\Test\\generated\\Type\\parent\\sibling\\JsonNumberEnum'
		);
		$o->enumOrNull = \JCG\Test\generated\Assert\parent\sibling\AssertJsonNumberEnum::assert(
			$o->enumOrNull,
			true,
			$path . '->enumOrNull:\\JCG\\Test\\generated\\Type\\parent\\sibling\\JsonNumberEnum'
		);
		$o->arrayOfEnums = \JCG\Test\generated\Util\AssertUtil::assertArray(
			 ...
			 */
			function ($value, $path) {
				return \JCG\Test\generated\Assert\parent\sibling\AssertJsonNumberEnum::assert(
					$value,
					false,
					$path
				);
		...
		/** @var \JCG\Test\generated\Type\parent\tests\JsonNumberEnumSiblingTest $result */
		$result = $o;
		return $result;
	}
}
